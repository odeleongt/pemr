...
#' the resulting object will include a list column containing a data frame
...
#' whether date/times were correctly interpreted.
#'
...
#'
#' @param .data `data.frame` containing a nested column with the data from each
#'   file. Usually a product of iterating `read_monitor` using `purrr::map2`.
